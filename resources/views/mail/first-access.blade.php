                                ...
                                <tr>
                                    <td style="{{ $defaultStyle }};max-width:100vw;padding:32px">
                                        ...
                                        <h1 style="{{ $defaultStyle }};color:#3d4852;font-size:18px;font-weight:bold;margin-top:0;text-align:left">
                                            Olá, {{ $user->name ?? 'novo usuário' }}!
                                        </h1>

                                        <p style="{{ $defaultStyle }};font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                            Você está recebendo esse e-mail pois seu usuário foi criado em nossa aplicação.
                                        </p>
                                        <p style="{{ $defaultStyle }};font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                            Para acessar, basta clicar no botão abaixo que será redirecionado para cadastrar sua senha de acesso.
                                        </p>
                                        ...
                                        <p style="{{ $defaultStyle }};font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                            Esse link irá expirar em {{ $expires }}.
                                        </p>
                                        <p style="{{ $defaultStyle }};font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                            Atenciosamente,<br>
                                            {{ config('app.name', 'CD') }}
