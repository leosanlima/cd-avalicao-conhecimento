<x-layouts.default>
    <x-slot name="title">Cadastro de endereços</x-slot>

    <section class="container mx-auto">
        <header>
            <h1 class="text-2xl font-semibold text-gray-900">Cadastrar endereço</h1>
        </header>


        <div class="w-full mt-5">
            <form action="{{url('enderecos')}}" method="POST" novalidate>
                @csrf
    ...
    @push('scripts')
        <script defer>
            window.addEventListener('load', function () {
                ...
                HGM.pages.customerAddress.create();
            })
        </script>
    @endpush
