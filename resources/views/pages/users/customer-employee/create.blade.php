                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden px-4 py-5 bg-white space-y-6 sm:p-6 rounded-md clear">
                    ...
                    <div id="allocation-form-section">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-full sm:col-span-4">
                                <p class="font-medium text-gray-600 mb-4">Cliente: {{ $customer->name }}</p>
                                <p class="font-medium text-gray-600">CNPJ: {{ $customer->cnpj }}</p>
                            </div>

                            <div class="col-span-full sm:col-span-4">
                                <x-label for="customer_address_id">Endereço:</x-label>

                                <x-select id="customer_address_id" name="customer_address_id">
                                    <option>Selecione</option>
                                    @foreach($customerAddresses as $customerAddress)
                                    <option
                                        value="{{ $customerAddress->id }}"
                                        {{ old('customer_address_id') == $customerAddress->id ? 'selected' : ''  }}
                                    >
